...
import PetCatIcon from '@/assets/images/pet-cat.svg';
import ArrowRightIcon from '@/assets/images/pet-arrow-right.svg';
  ...
  return (
    <Pressable
      ...
      <View style={styles.cta}>
        ...
        <Text style={styles.ctaText} numberOfLines={1}>点击查看详细信息</Text>
      </View>
    </Pressable>
  );
}
...
const styles = StyleSheet.create({
  ...
  traitWrap: {
    marginLeft: 83, // 69(头像宽) + 14(间距) = 83，与名字等信息纵向对齐
    paddingVertical: 7,
    borderRadius: 4,
  },
  traitText: {
